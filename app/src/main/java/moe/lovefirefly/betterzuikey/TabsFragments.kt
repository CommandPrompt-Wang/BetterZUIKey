                ...
                SettingItem.Combo(ctx.getString(R.string.settings_region), ctx.getString(R.string.settings_region_desc),
                    ...
                    onSelected = { idx ->
                        when (idx) {
                            ...
                            3 -> showCustomValueDialog(
                                R.string.region_custom_dialog_title,
                                R.string.region_custom_dialog_msg,
                                R.string.region_custom_dialog_hint,
                                cfg.regionCustomValue, blockEmpty = true
                            ) { c, v ->
                                c.regionCustomValue = v
                                c.regionOverride = moe.lovefirefly.betterzuikey.Region.RegionProfile.CUSTOM
                            }
                        }
                    }
                ),
                SettingItem.Combo(ctx.getString(R.string.settings_country), ctx.getString(R.string.settings_country_desc),
                    ...
                    onSelected = { idx ->
                        when (idx) {
                            ...
                            2 -> showCustomValueDialog(
                                R.string.country_custom_dialog_title,
                                R.string.country_custom_dialog_msg,
                                R.string.country_custom_dialog_hint,
                                cfg.countryOverride
                            ) { c, v -> c.countryOverride = v.uppercase() }
                        }
                    }
                ),
